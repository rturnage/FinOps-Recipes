...
## Overview
![Amortized Cost Summary](https://dummyimage.com/300x300/fff/aaa)

The Amortied Cost Summary table provides historic summary data for Amortized Costs.
...
## Example Data
See full dataset [/sample_data/AmortizedCostsSummary.csv](../sample_data/AmortizedCostsSummary.csv)
...
| Source |  Detail | 
|-----|------|
| `Amortized Cost` Common Dataset Table| [Amortized Cost](amortied_cost.md) 
